  ...
  return (
    <div className="min-h-screen bg-surface pb-24">
      <header className="sticky top-0 z-50 flex items-center px-4 h-16 bg-surface shadow-sm w-full">
        ...
        <h1 className="text-xl font-bold text-primary ml-4">Admin Dashboard</h1>
      </header>
      ...
      <main className="px-4 mt-6 max-w-md mx-auto">
        <section className="grid grid-cols-2 gap-4 mb-8">
          <div className="bg-white p-4 rounded-xl shadow-sm border border-outline-variant/20 flex flex-col items-center">
            ...
            <span className="text-xl font-bold text-on-surface">€ 1,245.00</span>
            <span className="text-xs font-semibold text-outline text-center">Revenue Today</span>
          </div>
          <div className="bg-white p-4 rounded-xl shadow-sm border border-outline-variant/20 flex flex-col items-center">
            <ShoppingBag size={24} className="text-blue-500 mb-2" />
            <span className="text-xl font-bold text-on-surface">32</span>
            <span className="text-xs font-semibold text-outline text-center">Orders Today</span>
          </div>
          <div className="bg-white p-4 rounded-xl shadow-sm border border-outline-variant/20 flex flex-col items-center">
            <Activity size={24} className="text-orange-500 mb-2" />
            <span className="text-xl font-bold text-on-surface">4</span>
            <span className="text-xs font-semibold text-outline text-center">Active Orders</span>
          </div>
          <div className="bg-white p-4 rounded-xl shadow-sm border border-outline-variant/20 flex flex-col items-center">
            <Users size={24} className="text-purple-500 mb-2" />
            <span className="text-xl font-bold text-on-surface">14</span>
            <span className="text-xs font-semibold text-outline text-center">New Users</span>
          </div>
        </section>
        ...
        <section className="space-y-4">
          <button onClick={() => navigate('adminOrders')} className="w-full flex items-center justify-between p-5 bg-white rounded-xl shadow-sm border border-outline-variant/20 hover:scale-[1.02] active:scale-[0.98] transition-all">
            <div className="flex items-center gap-4">
              ...
              <div className="flex flex-col items-start">
                <span className="text-base font-bold text-on-surface">Manage Orders</span>
                <span className="text-sm text-on-surface-variant">4 orders need attention</span>
              </div>
            </div>
          ...
          <button onClick={() => navigate('adminMenu')} className="w-full flex items-center justify-between p-5 bg-white rounded-xl shadow-sm border border-outline-variant/20 hover:scale-[1.02] active:scale-[0.98] transition-all">
            <div className="flex items-center gap-4">
              ...
              <div className="flex flex-col items-start">
                <span className="text-base font-bold text-on-surface">Menu Items</span>
                <span className="text-sm text-on-surface-variant">Add or edit products</span>
              </div>
            </div>
            <ArrowRight size={20} className="text-outline" />
          </button>

          <button className="w-full flex items-center justify-between p-5 bg-white rounded-xl shadow-sm border border-outline-variant/20 hover:scale-[1.02] active:scale-[0.98] transition-all opacity-50 cursor-not-allowed">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-full bg-purple-100 flex items-center justify-center text-purple-600">
                <Tag size={24} />
              </div>
              <div className="flex flex-col items-start">
                <span className="text-base font-bold text-on-surface">Offers & Promotions</span>
                <span className="text-sm text-on-surface-variant">Coming soon</span>
              </div>
            </div>
            <ArrowRight size={20} className="text-outline" />
          </button>
